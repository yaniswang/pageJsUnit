    ...
    return new Promise(function(resolve, reject){
        ...
        proxy.listen(0, function(msg){
            ...
            driver.session({
                ...
                var result = yield browser.eval(function(done){
                ...
                if(result){
                    ...
                    var jsCoverage = result.jsCoverage;
                    if(jsCoverage){
                        for(var file in jsCoverage){
                            var arrSource = mapJsCoverageSource[file];
                            if(arrSource){
                                jsCoverage[file].source = arrSource;
                            }
                        }
                    }
